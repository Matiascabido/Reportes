...
$sql = "select 'Cumplimiento normal' as Periodo, count(*) as Cantidad,  cast(sum([CUOTA_CAPITAL]) as decimal(19,2)) as Monto,
cast(sum(Total_Pagado) as decimal(19,2)) as Pagado, cast(sum([Saldo_Deudor_Calculado]) as decimal(19,2)) as SALDO_DEUDOR
from
(
SELECT 
cast((C.CRE_MONTO_OTORGADO /  C.CRE_CUOTAS_OTORGADAS) as decimal(19,2)) as [CUOTA_CAPITAL],
...
union all
select '1-29 dias.' as Periodo, count(*) as Cantidad,  cast(sum([CUOTA_CAPITAL]) as decimal(19,2)) as Monto,
cast(sum(Total_Pagado) as decimal(19,2)) as Pagado, cast(sum([Saldo_Deudor_Calculado]) as decimal(19,2)) as SALDO_DEUDOR
from
(
SELECT 
...
union all
select '30-90 dias.' as Periodo, count(*) as Cantidad,  cast(sum([CUOTA_CAPITAL]) as decimal(19,2)) as Monto,
cast(sum(Total_Pagado) as decimal(19,2)) as Pagado, cast(sum([Saldo_Deudor_Calculado]) as decimal(19,2)) as SALDO_DEUDOR
from
(
SELECT 
...
union all
select '91 - 180 dias.' as Periodo, count(*) as Cantidad,  cast(sum([CUOTA_CAPITAL]) as decimal(19,2)) as Monto,
cast(sum(Total_Pagado) as decimal(19,2)) as Pagado, cast(sum([Saldo_Deudor_Calculado]) as decimal(19,2)) as SALDO_DEUDOR
from
(
SELECT 
...
union all
select '> 180 dias.' as Periodo, count(*) as Cantidad,  cast(sum([CUOTA_CAPITAL]) as decimal(19,2)) as Monto,
cast(sum(Total_Pagado) as decimal(19,2)) as Pagado, cast(sum([Saldo_Deudor_Calculado]) as decimal(19,2)) as SALDO_DEUDOR
from
(
SELECT 
...
$sqlNo = "select 'Cumplimiento normal' as Periodo, count(*) as Cantidad,  cast(sum([CUOTA_CAPITAL]) as decimal(19,2)) as Monto,
cast(sum(Total_Pagado) as decimal(19,2)) as Pagado, cast(sum([Saldo_Deudor_Calculado]) as decimal(19,2)) as SALDO_DEUDOR
from
(
SELECT 
...
echo '    <h6>(Generar el Excel puede demorar varios minutos)</b></h6><br>';
echo '    <h4>FONCAP</b></h4>';
echo '</div>';
...
echo '<table class="table" style="text-align: center;" border ="1">';
echo '  <tr class="bg-primary" style="text-align: center;">';
echo '    <th style="text-align: center;">Periodo </th>';
echo '    <th style="text-align: center;">Cantidad </th>';
echo '    <th style="text-align: center;">Monto  </th>';
echo '    <th style="text-align: center;">Pagado </th>';
...
location.href = "anexoIII.php?mes="+$mes+"&año="+$año;
}
</script>'
;
?>