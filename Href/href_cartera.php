...
echo '                              <div class="col-md-6 col-md-offset-2">
                                       <button type="button" class="btn btn-light"" id="butonx"><a href ="javascript:openPage('.$mes.','.$año.')">Descargar Excel <span class="glyphicon glyphicon-download-alt"></span></button>
...
location.href = "excel_activados_mes.php?mes="+$mes+"&año="+$año;
}
</script>'
;
