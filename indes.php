        ...
        <section class="widget breadcrumb" widget="">
          ...
          <div class="widget-body">
            <a href="#menu-toggle" style="background-color: black"; class="btn" id="menu-toggle"><span class="glyphicon glyphicon-tasks"></span></a>
             <ol class="breadcrumb">
              <li class="breadcrumb-item"><h3 style="text-align: center"> REPORTES NO-FONCAP</h3></li>
                                ...
                                <fieldset>
                                  ...
                                  <b><i class="  glyphicon glyphicon-calendar"></i></b>
                                    ...
                                    <div class="col-md-6 col-md-offset-1 breadcrumb">
                                     <button id="btnrecupero" type="button" class="btn btn-primary btn-block" onclick="ReporteConami();">Conami Pagos</button>
                                    </div>
                                    <br>
                                    <br>
                                    <br>
                                    ...
                                    <div class="col-md-6 col-md-offset-1 breadcrumb">
                                     <button  id="btncartera" type="button" class="btn btn-primary btn-block" onclick="ReporteProcuracion();">Reporte Procuracion</button>
                                    </div>
                                    <br>
                                    <br>
                                    <br>
                                    <div class="col-md-6 col-md-offset-1 breadcrumb">
                                     <button type="button"  id="btncarteracomp" class="btn btn-primary btn-block" onclick="ReporteSeguro();">Reportes Seguro</button>
                                    </div>
                                    <br>
                                    <br>
                                    <br>
                                   ...
                                   <div class="col-md-6 col-md-offset-1 breadcrumb">
                                     <button type="button"  id="btnpistola" class="btn btn-primary btn-block" onclick="CapitalMes();">Pago Mensual</button>
                                    </div>
                                    <br>
                                    <br>
                                    <br>
                                    <div class="col-md-6 col-md-offset-1 breadcrumb">
                                     <button type="button"  id="btnLegajo" class="btn btn-primary btn-block" onclick="legajoPA();">Solicitudes PA</button>
                                    </div>
                                    <br>
                                    <br>
                                    <br> 
